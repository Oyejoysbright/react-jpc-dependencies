...
function NameBox({title = "name", subtitle = "subtitle", className, position = "fixed", top = "50vh", transform, right, bottom, left, location = Array, width, height, opacity = 1, zIndex = 0}) {
    return (
